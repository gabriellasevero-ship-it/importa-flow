-- Produto esgotado: visível no catálogo (active=true) mas sem permitir pedido.
...
-- Impede pedido via catálogo público para produtos esgotados.
...
COMMENT ON FUNCTION public.create_order_catalogo IS
  'Cria pedido+itens a partir do catálogo (anon). Rejeita produtos inativos ou esgotados.';
